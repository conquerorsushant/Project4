...
class ListingController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        $validated = $request->validate([
            ...
            'operating_hours.*.open' => ['required_unless:operating_hours.*.closed,true', 'date_format:H:i'],
            'operating_hours.*.close' => ['required_unless:operating_hours.*.closed,true', 'date_format:H:i'],
            'operating_hours.*.closed' => ['nullable', 'boolean'],
            'services' => ['nullable', 'array'],
            'services.*' => ['string', 'max:255'],
            'hide_business_hours' => ['nullable', 'boolean'],
